...
class Email{
    ...
    public function __construct($tr) {
        ...
        $elements_in = array($this->title,$tr->tr_type_name,$this->num_subs,$tr->date,$tr->time,$tr->tr_program_name,$tr->month,$tr->futures_name,$tr->entry_choice,$tr->op_entry_choice,$tr->duration,$tr->entry_price,$tr->price_target,$tr->stop_loss,$tr->description,$this->disclosure,$this->sender_email,$this->company_website,$this->company_name,$this->sender_address);
        $elements_out = array('[TITLE]','[TRADE_TYPE]','[BLOCK_ORDER]','[DATE]','[TIME]','[PROGRAM]','[MONTH]','[FUTURE]','[ENTRY_CHOICE]','[OP_ENTRY_CHOICE]','[DURATION]','[ENTRY_PRICE]','[PRICE_TARGET]','[STOP_LOSS]','[DESCRIPTION]','[DISCLOSURE]','[SENDER_EMAIL]','[COMPANY_WEBSITE]','[COMPANY_NAME]','[ADDRESS]');
