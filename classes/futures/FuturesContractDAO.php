...
class FuturesContractDAO {
    public static function GetFutures(){
        ...
        try{
            $res = $db->prepare("SELECT id_futures,fk_tr_program,futures_name,description,dec_places,tr_program_name,futures_cont.status "
                . "FROM futures_cont "
    ...
    public static function NewFutures($future){
        ...
        try{
            $res = $db->prepare("INSERT INTO futures_cont "
                . "(id_futures,futures_name,fk_tr_program,description,dec_places) "
                . "VALUES ('',:futures_name,:fk_tr_program,:description,:dec_places)");
            $res->bindParam(':futures_name',$future['futures_name']);
            $res->bindParam(':fk_tr_program',$future['futures_prog']);
