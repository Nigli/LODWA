...
<div id="notice">
    ...
    <form id="receiver_list_filter" method="get" class="hidden">
        ...
        <label for="receiver_list_type">By Receiver Type</label><br>
    ...
    <div id="bottom">
        <div id="bottom-left">
            ...
            <button id="notice-confirm-filter" class="hidden" type="submit" form="receiver_list_filter">Confirm</button>
