...
<div id="notice">
    ...
    <div id="bottom">
        <div id="bottom-left">            
            ...
            <button id="notice-confirm-futures" type="submit" name="futures-submit" form="left">Confirm</button>            
            <button id="notice-confirm-strategy" type="submit" name="strategy-submit" form="right">Confirm</button>
        </div>
    </div>
</div>
<div id="strategy_list_form" class="edit">
    ...
    <form id="left" method="post" action="processfut">
        <h3>Futures</h3>    
    ...
    <form id="right" method="post" action="processstrat">
        <h3>Strategy</h3>
    ...
    <div id="bottom">
        <div id="bottom-left">
            <button form="left" id="update-left" class="update" type="button" value="update" onclick="getValFutur(this)">Update</button>   
            <button form="left" id="delete-left" class="delete" type="button" value="delete" onclick="getValFutur(this)">Delete</button>         
            <button form="left" id="reset-left" class="reset" type="reset" value="reset">Clear</button>
            <button form="left" id="new-left" type="button"  value="new" onclick="getValFutur(this)">New</button>
        </div>
        <div id="bottom-right">            
            <button form="right" id="update-right" class="update" type="button" value="update" onclick="getValStrat(this)">Update</button>
            <button form="right" id="delete-right" class="delete" type="button" value="delete" onclick="getValStrat(this)">Delete</button>
            <button form="right" id="reset-right" class="reset" type="reset" value="reset">Clear</button>
            <button form="right" id="new-right" type="button" value="new" onclick="getValStrat(this)">New</button>
        </div>
    </div>
</div>
<script>         
